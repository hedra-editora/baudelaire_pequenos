...
\section[Pequenos poemas em prosa]{pequenos 
poemas em prosa\break (o spleen de paris)\protect\footnote{O texto francês segue 
o estabelecido por Marcel A. Ruff para as {\itshape \OE uvres 
complètes de Baudelaire} editadas pelas Editions du Seuil, 
coleção L'Intégrale, Paris, 1968. Foram consultadas também a
edição crítica dos {\itshape Petits poèmes en prose}, Classiques Garnier, Paris,
1980 (da qual foram seguidos os textos dos poemas \textsc{xliv} a \textsc{xlvii}) e
Nouveaux Classiques Larousse, Paris, 1971.}}
